...
const divisions = [
  ...
  },
  {
    id: 'research',
    title: 'RISET',
    imageSrc: '/images/riset1.jpeg',
  },
  {
    id: 'practicum',
    title: 'PRAKTIKUM',
    imageSrc: '/images/practicum1.jpeg', 
  },
] as const;
...
export default function DivisionSection() {
  ...
  return (
    <div className="bg-gradient-to-br from-[#2a0a0f] via-red-800 to-[#2a0a0f] w-full md:flex items-center justify-center mb-6 md:mb-12 mt-0 md:mt-2 relative overflow-hidden rounded-3xl px-4">
      <div className="relative top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40px] h-[10px] md:h-[400px] bg-red-900/20 rounded-full blur-3xl z-0" />
      ...
      >
        ...
        <div className="relative w-full h-auto md:h-[400px] flex flex-col items-center md:flex-row md:items-center md:justify-center gap-6 p-4">
